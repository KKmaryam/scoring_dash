...
liste_clients = list(X_test_clean()['sk_id_curr'])
...
payload = {'id_client': ID_client}
r=requests.get('https://projetflask.herokuapp.com/get_score_credit', params=payload)       
#r='https://projetflask.herokuapp.com/get_score_credit/'+ str(ID_client)
...
plt.title("Interprétation Globale :\n Diagramme d'Importance des Variables", 
            ...
            fontsize=20, 
            fontstyle='italic')
st_shap(shap.summary_plot(valeurs_shap()[1], 
...
st_shap(shap.force_plot(explainer_shap.expected_value[0], 
                            shap_values[0][idx,:], 
...
st.markdown("""
                ...
                9. Histogramme""", 
                unsafe_allow_html=True)
new_df_2 =df.assign(  score=score)
st.plotly_chart(px.histogram(new_df_2, y="ext_source_2", x='sk_id_curr', color="score"))
